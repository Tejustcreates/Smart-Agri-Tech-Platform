...
const CropRecommender: React.FC = () => {
  ...
  return (
    <section id="crop-recommender" className="snap-section min-h-screen flex flex-col justify-center border-t border-gray-100 bg-gradient-to-b from-green-50/40 to-white">
