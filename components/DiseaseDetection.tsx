...
const DiseaseDetection: React.FC = () => {
  ...
  return (
    <section id="disease-detection" className="snap-section min-h-screen flex flex-col justify-center items-center border-t border-gray-100 bg-gradient-to-b from-amber-50/40 to-white">
