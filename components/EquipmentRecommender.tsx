...
const EquipmentRecommender: React.FC<{ onAddToCart: (product: any, type: any) => void }> = ({ onAddToCart }) => {
  ...
  return (
    <section id="equipment-recommender" className="snap-section min-h-screen flex flex-col justify-center items-center border-t border-gray-100 bg-gradient-to-b from-orange-50/40 to-white">
